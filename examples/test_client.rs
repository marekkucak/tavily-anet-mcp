...
async fn main() -> Result<()> {
    ...
    println!("Tavily search response: {}", serde_json::to_string_pretty(&search_response)?);
    ...
    println!("Tavily extract response: {}", serde_json::to_string_pretty(&extract_response)?);
